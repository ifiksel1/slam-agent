...
- [GenZ-ICP evaluation](genz_icp_evaluation.md) — GenZ-LIO unreleased; LiDAR-only GenZ-ICP matched BIEVR-LIO's 1.3cm on 3rd_floor with NO IMU, and on the 12 hangar bags is 12/12 bounded (0 divergences, beats BIEVR 10/12, kills both km blow-ups) BUT still median 11.3m drift → bounded-not-accurate; absolute anchor still required
