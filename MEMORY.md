...
- [GenZ-ICP evaluation](genz_icp_evaluation.md) — GenZ-LIO unreleased; LiDAR-only GenZ-ICP = 1.3cm on 3rd_floor + 12/12 bounded on hangar bags with 0 divergences (beats BIEVR 10/12, kills both km blow-ups), NO IMU. ⚠️ 1.0x sweep drift numbers RETRACTED as scan-starved — worst bag went 15.35m→0.21m at 0.5x (GT 0.273m); needs full 0.5x re-sweep
