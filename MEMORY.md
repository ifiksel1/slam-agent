...
- [GenZ-ICP evaluation](genz_icp_evaluation.md) — GenZ-LIO unreleased; LiDAR-only GenZ-ICP matched BIEVR-LIO's 1.3cm on 3rd_floor with no IMU (3/3 runs); hangar sweep pending
